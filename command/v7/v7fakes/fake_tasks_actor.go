...
type FakeTasksActor struct {
	...
	GetApplicationTasksStub        func(appGUID string, sortOrder v7action.SortOrder) ([]v7action.Task, v7action.Warnings, error)
	getApplicationTasksMutex       sync.RWMutex
	getApplicationTasksArgsForCall []struct {
		appGUID   string
		sortOrder v7action.SortOrder
	}
...
func (fake *FakeTasksActor) GetApplicationByNameAndSpace(appName string, spaceGUID string) (v7action.Application, v7action.Warnings, error) {
...
func (fake *FakeTasksActor) GetApplicationTasks(appGUID string, sortOrder v7action.SortOrder) ([]v7action.Task, v7action.Warnings, error) {
