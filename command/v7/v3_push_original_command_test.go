...
var _ = Describe("v3-push Command", func() {
	var (
		cmd             v7.V3PushCommand
		testUI          *ui.UI
		fakeConfig      *commandfakes.FakeConfig
		fakeSharedActor *commandfakes.FakeSharedActor
		fakeNOAAClient  *v7fakes.FakeNOAAClient
		fakeActor       *v7fakes.FakeOriginalV3PushActor
		fakeV2PushActor *v7fakes.FakeOriginalV2PushActor
	...
	BeforeEach(func() {
		...
		fakeActor = new(v7fakes.FakeOriginalV3PushActor)
		fakeV2PushActor = new(v7fakes.FakeOriginalV2PushActor)
		fakeV2AppActor = new(sharedfakes.FakeV2AppActor)
		fakeNOAAClient = new(v7fakes.FakeNOAAClient)
