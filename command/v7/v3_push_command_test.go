...
var _ = Describe("v3-push Command", func() {
	var (
		...
		fakeActor        *v7fakes.FakeV3PushActor
		fakeVersionActor *v7fakes.FakeV3PushVersionActor
	...
	BeforeEach(func() {
		...
		fakeActor = new(v7fakes.FakeV3PushActor)
		fakeVersionActor = new(v7fakes.FakeV3PushVersionActor)
