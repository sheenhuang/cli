...
func (fake *FakeSharedSSHActor) ExecuteSecureShell(sshClient sharedaction.SecureShellClient, sshOptions sharedaction.SSHOptions) error {
...
var _ v3.SharedSSHActor = new(FakeSharedSSHActor)
