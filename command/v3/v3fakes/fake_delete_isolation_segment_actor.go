...
type FakeDeleteIsolationSegmentActor struct {
	...
	DeleteIsolationSegmentByNameStub        func(name string) (v7action.Warnings, error)
...
func (fake *FakeDeleteIsolationSegmentActor) DeleteIsolationSegmentByName(name string) (v7action.Warnings, error) {
