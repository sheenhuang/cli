...
type commandList struct {
	...
	Delete                             v3.DeleteCommand                             `command:"delete" alias:"d" description:"Delete an app"`
	...
	Env                                v3.V3EnvCommand                              `command:"env" alias:"e" description:"Show all env variables for an app"`
	...
	Scale                              v3.ScaleCommand                              `command:"scale" description:"Change or view the instance count, disk space limit, and memory limit for an app"`
